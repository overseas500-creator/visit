...
// Initialize the database tables only if we just created the connection (or check simply)
// Ideally, we can run this every time safely, but with the singleton it runs once per server start/restart
db.exec(`
